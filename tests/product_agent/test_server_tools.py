"""Test Product Agent MCP server tools."""

import pytest
from servers.product_agent.server import product_analyze, product_search, health_check
...
class TestMCPTools:
    ...
    async def test_mcp_04_product_search_raw_rag(self):
        ...
        result = await product_search({"q": "payroll", "top_k": 3})
    ...
    async def test_mcp_07_tool_privilege_denied(self):
        ...
        from servers.product_agent.server import mcp
    ...
    async def test_health_check(self):
        ...
        assert result["service"] == "product-agent"