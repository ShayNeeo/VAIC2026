    ...
    if settings.DATABASE_URL:
        ...
        with adapter._connect() as conn:
            with conn.cursor() as cur:
                ...
                cur.execute(
                    "INSERT INTO companies (tax_id, company_name, established_date, legal_form, registered_address, business_address) VALUES (%s, %s, '2024-01-01', 'Khác', 'Chua cung cap', 'Chua cung cap') ON CONFLICT (tax_id) DO NOTHING",
